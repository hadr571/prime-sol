export default class Carousel {
    ...
    // Initialize all event listners and call the required functions
    init() {
    ...
    updateFillerElements() {
        //This condition will make the function prematurely return if the carousel-filler element doesn't exist
        if (this.carouselElement.querySelector(".carousel__filler") === null) {
            return;
        }
